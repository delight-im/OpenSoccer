<?php include 'zz1.php'; ?>
<title><?php echo _('Android™-App'); ?> - <?php echo CONFIG_SITE_NAME; ?></title>
<?php if ($loggedin == 1) { ?>
<style type="text/css">
<!--
...
<p><?php echo _('Du hast ein Smartphone oder Tablet mit Android? Dann spiele ganz einfach von unterwegs:'); ?></p>
<ol>
<li><?php echo _('Aktiviere unter <em>Einstellungen</em> &raquo; <em>Anwendungen</em> das Kästchen bei &quot;Unbekannte Quellen&quot;, damit Du die App von dieser Seite aus installieren kannst.'); ?></li>
