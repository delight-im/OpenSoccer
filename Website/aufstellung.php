...
<?php } else { ?>
.spielfeld { position:relative; left:0px; top:0px; width:522px; height:400px; background:white url(http://s3.amazonaws.com/ballmanager.de/images/fussballfeld.png) scroll no-repeat; color:#fff; font-weight:bold; z-index:1; }
select { width:120px; }
