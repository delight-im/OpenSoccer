...
if ($kontakt2a == 'noch keine') { echo '<p>'._('Wenn Du Deine Freunde zu dieser Liste hinzufügen möchtest, dann öffne bitte das Profil des jeweiligen Managers und klicke unten auf den Link &quot;Freundschaft anbieten&quot;.').'</p>'; }
    ...
    while ($kontakt3 = mysql_fetch_assoc($kontakt2)) {
		...
		echo '<td><a href="/freunde.php?sort='.$sortUp.'&amp;user='.$kontakt3['f2'].'"><img src="/images/arrow_up.png" alt="+" title="Nach oben verschieben" /></a> <a href="/freunde.php?sort='.$sortDown.'&amp;user='.$kontakt3['f2'].'"><img src="/images/arrow_down.png" alt="-" title="Nach unten verschieben" /></a></td>';
		echo '</tr>';
    }
    echo '</tbody></table></p>';
}
