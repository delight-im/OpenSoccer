<?php include 'zz1.php'; ?>
<title>Gelöschte Accounts | Ballmanager.de</title>
<?php include 'zz2.php'; ?>
<?php if ($loggedin == 1) { ?>
<?php
if ($_SESSION['status'] == 'Helfer' OR $_SESSION['status'] == 'Admin') {
	...
	echo '<h1>Gelöschte Accounts</h1>';
	echo '<p>Die folgenden Accounts wurden zuletzt gelöscht. Entweder war der Manager nicht mehr aktiv oder er hat seinen Account unter &quot;Einstellungen&quot; gelöscht.</p>';
	echo '<table><thead><tr class="odd"><th scope="col">Manager</th><th scope="col">Gelöscht</th><th scope="col">Dabei</th><th scope="col">Liga</th></tr></thead><tbody>';
	$counter = 0;
