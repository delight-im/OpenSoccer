<?php include 'zz1.php'; ?>
<title>Ergebnisverlauf | Ballmanager.de</title>
<?php include 'zz2.php'; ?>
<?php include 'zzsubnav_statistik.php'; ?>
<?php if ($loggedin == 1) { ?>
<h1>Ergebnisverlauf</h1>
<p>Dieses Liniendiagramm zeigt die Entwicklung Deiner Ergebnisse in der aktuellen Saison. Hinweis: Die Daten können erst nach zwei Spielen angezeigt werden.</p>
<p>
<?php
