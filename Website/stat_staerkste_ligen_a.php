<?php include 'zz1.php'; ?>
<title>Stärkste Ligen - Aufstellung | Ballmanager.de</title>
<style type="text/css">
<!--
...
<h1>Stärkste Ligen - Aufstellung</h1>
<?php if ($loggedin == 1) { ?>
<p>Jedes Team besitzt eine Aufstellungsstärke. Am Durchschnitt dieser Stärken innerhalb der einzelnen Ligen wird hier deren Stärke gemessen.</p>
<p>
<table>
<thead>
<tr class="odd">
...
<tbody>
<?php
$ausdruck = "(SELECT AVG(aufstellung) FROM man_teams WHERE liga = man_ligen.ids)";
