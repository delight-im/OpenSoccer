        ...
        if ($sql2a > 0) {
            ...
            if ($sperre3 > 13) {
                if ($_POST['typ'] == 'Kauf') { // Verkaufen
					...
					$buch2 = mysql_query($buch1);
					$formulierung = 'Du hast den Spieler <a href="/spieler.php?id='.$spieler_id.'">'.$spielerName.'</a> für '.number_format($sql3['marktwert'], 0, ',', '.').' € an einen Verein außerhalb Europas verkauft.';
