...
<div id="wrap">
<div id="header">
<div class="logo_top" style="position:relative"><img src="http://s3.amazonaws.com/ballmanager.de/images/logo260x60.png" alt="Ballmanager - Online-Fußball-Manager" title="Ballmanager - Online-Fußball-Manager" width="260" style="border:0; width:260px; height:60px" />
<?php
...
<?php if ($cookie_team != '__'.$cookie_id) { ?>
<?php
$nextGamesHTML = '<h1>Nächste Spiele</h1><div class="left-box navBlockLinks">';
...
while ($nxt3 = mysql_fetch_assoc($nxt2)) {
	...
	$nextGamesHTML .= '<a href="/spielbericht.php?id='.$nxt3['id'].$lastActionZusatz.'">'.$nxt3_typ.': '.$nxt3_gegner.' ('.$ergebnis_live.')</a>';
}
$nextGamesHTML .= '</div>';
echo $nextGamesHTML;
?>
